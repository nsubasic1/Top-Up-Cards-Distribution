...
export default function ProdajnoMjesto(props) {
    ...
    const dodajProdajnoMjesto = (e) => {
        ...
        novi.title = naziv;
        novi.subtitle = opis;
        novi.type = "Prodajno mjesto";
        node.children.push(novi)
        setShown(false)
        setTreeData([treeData[0]])
    };
    
    const izmijeniProdajnoMjesto = (e) => {
    ...
    const getNaslov = () =>
        edit ? "Izmjena prodajnog mjesta" : "Kreiranje prodajnog mjesta";
    ...
    return (
        <Modal show={show} onHide={ponistiPromjene}>
            ...
            <Modal.Body>
                <Form>
                    <Form.Group className="mb-3" controlId="formBasicIme">
                        <Form.Label>Naziv prodajnog mjesta</Form.Label>
                        <Form.Control
                            type="text"
                            placeholder="Naziv"
                            required
                    ...
                    <Form.Group className="mb-3" controlId="formBasicOpis">
                        <Form.Label>Opis prodajnog mjesta</Form.Label>
                        <Form.Control
                            type="text"
                            placeholder="Opis"
                            required
            ...
            <Modal.Footer>
                ...
                <Button onClick={edit ? izmijeniProdajnoMjesto : dodajProdajnoMjesto}>
                    Prihvati
                </Button>
            </Modal.Footer>
        </Modal>
